...
CREATE TABLE IF NOT EXISTS events (
  ...
  occurred_at_device DATETIME(3) NULL,
  received_at DATETIME(3) NULL,
  persisted_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  boot_id VARCHAR(128) NULL,
  device_uptime_ms BIGINT UNSIGNED NULL,
  clock_quality ENUM('synced', 'unsynced', 'unknown') NOT NULL DEFAULT 'unknown',
